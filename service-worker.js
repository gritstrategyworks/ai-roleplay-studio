...
const CORE=['index.html','styles.css?v=1.15','app.js?v=1.15','local-ai.js?v=1.15','local-ai-worker.js?v=1.15','manifest.webmanifest','assets/icon.svg'].map(path=>new URL(path,BASE).href);
