...
const CORE=['index.html','styles.css?v=1.26','auth.css?v=1.26','auth.js?v=1.26','app.js?v=1.26','scenario-design.js?v=1.26','manifest.webmanifest','assets/icon.svg'].map(path=>new URL(path,BASE).href);
